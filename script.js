...
dataProductos.forEach(p=>{
  ...
  card.innerHTML = `
    ...
    <div class="actions">
      <a class="btn btn-primary" href="https://wa.me/595000000000?text=Hola%20Granja%20La%20Familia,%20quiero%20${encodeURIComponent(p.nombre)}">Comprar</a>
...
function enviarMensaje(e){
  ...
  const numero = "595000000000"; // <-- CAMBIAR
